...
function AuthForm({ type, onSuccess, onSwitch }) {
  ...
  const styles = {
    ...
    authHeader: { marginBottom: '2rem', textAlign: 'center' },
    authIconContainer: { display: 'flex', justifyContent: 'center', marginBottom: '1.5rem' },
    authTitle: { fontSize: '1.875rem', fontWeight: '700', color: '#0f172a', marginBottom: '0.5rem' },
    authSubtitle: { color: '#64748b', fontSize: '0.9375rem', lineHeight: '1.5' },
    ...
    divider: { position: 'relative', textAlign: 'center', margin: '1.5rem 0', borderTop: '1px solid #e5e7eb' },
    dividerText: { position: 'relative', top: '-0.6rem', background: 'white', padding: '0 0.75rem', color: '#94a3b8', fontSize: '0.875rem', fontWeight: '500' },
    switchText: { textAlign: 'center', marginTop: '1.5rem', color: '#64748b', fontSize: '0.875rem' },
    link: { color: '#6366f1', cursor: 'pointer', fontWeight: '600', textDecoration: 'none' }
  };
    ...
    <div style={styles.formContainer}>
      <div style={styles.card}>
        <div style={styles.authHeader}>
          ...
          <h2 style={styles.authTitle}>{type === 'login' ? 'Welcome back' : 'Create your account'}</h2>
          <p style={styles.authSubtitle}>{type === 'login' ? 'Enter your credentials to access your account' : 'Start your journey with us today'}</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" style={styles.btnFull} disabled={loading}>
            {loading ? 'Processing...' : type === 'login' ? 'Sign in to your account' : 'Create account'}
          </button>
        </form>
